...
/**
 * @extends ServiceEntityRepository<BiensImmobiliers>
 *
...
class BiensImmobiliersRepository extends ServiceEntityRepository
{
    ...
    public function save(BiensImmobiliers $entity, bool $flush = false): void
    {
    ...
    public function remove(BiensImmobiliers $entity, bool $flush = false): void
    {
